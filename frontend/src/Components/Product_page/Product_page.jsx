...
import laptop1 from '../../../public/images/greylaptop.png'
import laptop2 from '../../../public/images/facebook_icon.svg'
import laptop3 from '../../../public/images/greylaptop.png'
import laptop4 from '../../../public/images/greylaptop.png'

export default function MacBookProductPage() {
  // State for quantity
                ...
                {productImages.map((img, index) => (
                  <div 
                    ...
                    className={`w-16 h-16 border rounded cursor-pointer ${
                      index === currentSlide ? 'border-blue-500 ring-2 ring-blue-200' : 'border-gray-300'
                    }`}
                  >
                    <img 
                      src={img} 
